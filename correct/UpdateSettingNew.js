document.addEventListener("DOMContentLoaded", function () {
    ...
    function populateStoreListWithStatusInfo(stores, location, status) {
      const storeList = document.querySelector("#storeList");
      const storeCountElement = document.querySelector("#storeCount");
      ...
      stores.forEach((store, index) => {
        ...
        <div class="store-card">
          ...
          store.address.state
        }, ${store.address.country}, ${store.address.postalCode}</p>
    ...
    //   .getElementById("statusSwitch")
    //   .addEventListener("change", function () {
    //     const openStatus = this.checked ? "open" : "closed";
    //     const statusLabel = document.getElementById("statusLabel");
    //     statusLabel.textContent =
    //       openStatus.charAt(0).toUpperCase() + openStatus.slice(1);
