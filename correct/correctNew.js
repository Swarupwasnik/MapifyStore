document.addEventListener("DOMContentLoaded", function () {
    ...
    if (distanceSlider && distanceLabel && categorySelect && statusSwitch) {
      ...
      categorySelect.addEventListener("change", function () {
        // Reset the distance slider to its default value
        distanceSlider.value = 10; // Default distance value
        updateDistanceLabel(10);   // Update the label accordingly
    
        // Reset the status switch to default (unchecked)
        statusSwitch.checked = false;
    
        // Fetch stores with updated category and default settings
